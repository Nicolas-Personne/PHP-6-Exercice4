  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="jumbotron col-4">
        <a href="index.php?language=PHP&server=LAMP"><button type="button"class="btn btn-primary" name="button">clic</button></a>
        <?php
        if (isset($_GET['language']) && isset($_GET['server'])){ // vérifie si On a le age
